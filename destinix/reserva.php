...
// Definición de la clase ReservaModel dentro del mismo archivo
class ReservaModel {
    private $conn;
    ...
    public function addreserva($fecha_reserva, $fecha_visita, $cantidad_personas, $restaurante_id, $sitio_id, $hotel_id, $estado_id, $empresa_id, $id_itinerario) {
